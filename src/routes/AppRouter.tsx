...
export const AppRouter = () => {
    ...
    useEffect(() => {
        if (sessionUser.userLoggued) {
            sessionStorage.setItem("identity", AES.encrypt(JSON.stringify(sessionUser), import.meta.env.VITE_IDENTITY_KEY).toString());
        }
    }, [sessionUser])
    ...
    return (
        <>
            <LoginRegisterContext.Provider value={{ loginRegister, setLoginRegister }}>
                                ...
                                !sessionUser.userLoggued ?
                                    ...
                                    <Routes>
                                        <Route path="/dashboard" element={<SideNav />}>
                                            ...
                                            <Route path="balanceSaldos" element={<LibroDiario />} />
